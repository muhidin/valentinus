...
// $sql="SELECT count(idbanner) as jbanner FROM banner";
// $query=mysqli_query($koneksi,$sql);
// $r=mysqli_fetch_assoc($query);
// echo "<h3>".$r['jbanner']."</h3>";
?>
              <p>Banner Terdaftar</p>
            </div>
            <div class="icon">
              <i class="ion ion-bag"></i>
            </div>
            <a href="?m=banner" class="small-box-footer">Info Banner <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
