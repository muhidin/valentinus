        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="<?php if ($aktif == 'Banner') echo 'active'; ?> treeview">
                        <a href="#">
                            <i class="fa fa-graduation-cap"></i> <span>Banner</span>
                            <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                            <li><a href="?m=banner"><i class="fa fa-list"></i> Daftar</a></li>
                            <li><a href="?m=banner&s=tambah"><i class="fa fa-plus"></i> Tambah</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="<?php if ($aktif == 'utama') echo 'active'; ?> treeview">
                        <a href=".." target="blank">
                            <i class="fa fa-pie-chart"></i> <span>Ke Web Utama</span>
                        </a>
                    </li>
                    <li>
                        <a href="logout.php">
